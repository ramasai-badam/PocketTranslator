...
export const MODEL_CONFIG = {
  ...
  llama: {
    url: 'https://huggingface.co/bartowski/google_gemma-3n-E2B-it-GGUF/resolve/main/google_gemma-3n-E2B-it-Q4_1.gguf',
    path: `${FileSystem.documentDirectory}gemma-3n-E2B-Q4_1.bin`,
